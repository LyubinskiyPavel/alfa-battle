...
public class ATMDetails {
    ...
    @SerializedName("availablePaymentSystems")
    private List<String> availablePaymentSystems = null;

    @SerializedName("cashInCurrencies")
    private List<String> cashInCurrencies = null;

    @SerializedName("cashOutCurrencies")
    ...
    public ATMDetails recordUpdated(String recordUpdated) {
